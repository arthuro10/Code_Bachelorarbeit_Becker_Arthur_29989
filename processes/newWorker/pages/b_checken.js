...
const B_Checken = () => {
    ...
    return (
      <div style={zentriert}>
        <h1>B - Checken - Data </h1>
        <h2>Firstname: {information.firstName}</h2>
        <h2>LastName: {information.lastName}</h2>
        <h2>About: {information.about}</h2>
        <h2>Gender: {information.gender}</h2>
        <h2>Job: {information.job}</h2>
